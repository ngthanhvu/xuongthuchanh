                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <i class="fa-solid fa-check"></i> {{ $course->description ?? 'Các kiến thức căn bản, nền móng của ngành IT' }}
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="accordion-body">
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <span class="float-end">{{ $lesson->duration ?? '10:00' }}</span>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
            ...
            <div class="card card-custom">
                <div class="card-body text-center">
                    ...
                    <ul class="list-unstyled mt-3">
                        ...
                        <li><i class="bi bi-check-circle me-2"></i> Thời lượng {{ $course->duration ?? '03 giờ 26 phút' }}</li>
