...
@section('content')
    ...
    <div class="tw-flex tw-justify-between tw-items-center tw-mb-6">
        ...
        <a href="{{ route('teacher.sections.create') }}" class="btn btn-outline-secondary">
                ...
                @foreach ($sections as $section)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('teacher.sections.edit', $section->id) }}"
                                class="btn btn-sm btn-outline-primary tw-me-1">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <form action="{{ route('teacher.sections.delete', $section->id) }}" method="POST"
